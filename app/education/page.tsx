...
export default function Education() {
  ...
  const bscThirdYear = [
    ...
    },
    {
      ...
      projects: [
        {
          name: "Mobile Car Driving",
          url: "https://github.com/filipepcampos/mobile-car-driving-model",
        },
      ],
    },
    {
        ...
        <section id="msc">
          <div className="relative overflow-x-auto sm:rounded-lg">
            <div className="p-5 text-2xl font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
              <h2>MSc in Informatics and Computing Engineering</h2>
            ...
            <div className="flex flex-col gap-4">
              <UniversitySemesterSection title="1st Year" data={firstYear} />
              <UniversitySemesterSection title="2nd Year" data={secondYear} />
            </div>
          </div>
        </section>
        <section id="bsc">
          <div className="relative overflow-x-auto sm:rounded-lg">
            ...
            <div className="flex flex-col gap-4">
              <UniversitySemesterSection title="1st Year" data={bscFirstYear} />
              <UniversitySemesterSection
                title="2nd Year"
                data={bscSecondYear}
              />
              <UniversitySemesterSection title="3rd Year" data={bscThirdYear} />
            </div>
          </div>
        </section>
      </div>
