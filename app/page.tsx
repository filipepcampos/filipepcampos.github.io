      ...
      <div className="flex flex-col items-center justify-center min-h-screen max-w-screen-lg mx-auto py-2 px-4 gap-2">
        ...
        <ScrollAnimation animateIn="fadeIn">
          <div className="min-h-screen flex flex-col justify-center">
            <p className="text-blue-800 text-sm md:text-md font-extrabold dark:text-orange-500">
              Hello, my name is
            </p>
            <h1 className="mb-4 text-6xl font-black tracking-tight leading-none md:text-8xl dark:text-white">
              Filipe Campos
            </h1>
            <p className="max-w-4xl text-gray-600 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              Hi! I&apos;m a recent graduate in Informatics and Computing Engineering
              from FEUP. I love a good challenge and I&apos;m always looking for new
